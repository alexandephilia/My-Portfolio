    ...
    return (
        ...
        >
            <div className="relative w-full h-full bg-none">
                {/* Layer 1: Subtle blur (top portion) */}
                <div style={{
                    position: 'absolute', inset: 0, zIndex: 1,
                    backdropFilter: 'blur(0.5px)', WebkitBackdropFilter: 'blur(0.5px)',
                    maskImage: 'linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 65%)',
                    WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,0) 0%, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 65%)'
                }} />
                {/* Layer 2: Medium blur (middle portion) */}
                <div style={{
                    position: 'absolute', inset: 0, zIndex: 2,
                    backdropFilter: 'blur(2px)', WebkitBackdropFilter: 'blur(2px)',
                    maskImage: 'linear-gradient(to bottom, rgba(0,0,0,0) 40%, rgba(0,0,0,1) 70%, rgba(0,0,0,0) 90%)',
                    WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,0) 40%, rgba(0,0,0,1) 70%, rgba(0,0,0,0) 90%)'
                }} />
                {/* Layer 3: Heavy blur (bottom portion) */}
                <div style={{
